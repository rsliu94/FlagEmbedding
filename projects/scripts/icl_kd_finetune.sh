...
train_data="\
    ../data/embedder_train_eval_data/cross_validation/finetune_data_hn_mined_round2_score.jsonl \
"
eval_data="\
    ../data/embedder_train_eval_data/cross_validation/finetune_data_hn_mined_round2_test_score.jsonl  \
"
...
save_steps=219
output_dir="../model_output/icl_kd_finetune_round1"
