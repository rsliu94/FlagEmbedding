...
from FlagEmbedding import FlagLLMReranker, LightWeightFlagLLMReranker, LayerWiseFlagLLMReranker
...
if __name__ == "__main__":
    ...
    model = FlagLLMReranker(
        ...
        devices=args.device,   # if you don't have GPUs, you can use ["cpu", "cpu"]
        cache_dir=os.getenv('HF_HUB_CACHE', None),
    )
    # elif args.model_path == 'BAAI/bge-reranker-v2.5-gemma2-lightweight':
    ...
    #     )
    # elif args.model_path == 'BAAI/bge-reranker-v2-minicpm-layerwise':
