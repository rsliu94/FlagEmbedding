...
train_data="\
    ../data/hn_mine_data_zero_round/submission/finetune_data_minedHN.jsonl \
"
...
output_dir="../model_output/icl_finetune_submission_round1"
learning_rate=1e-4
...
# no need for eval data when finetuning on submission data
data_args="\
